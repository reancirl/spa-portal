...
class InquiryStatus
{
    ...
    public static $statusDescriptions = [
        self::STAT_PENDING => 'Inquiry is pending.',
        self::STAT_DETAILS_SENT => 'Details sent for inquiry.',
        self::STAT_CLOSED_BOOKED => 'Inquiry is closed for booked.',
        self::STAT_CLOSED_SALES => 'Inquiry is closed for sales.',
        self::STAT_CLOSED_CONVERT_FALSE => "Inquiry is closed (didn’t convert).",
    ];
