<template>
  <admin>
    ...
    <v-row v-if="userType">
      <v-col>
        <v-card>
          <toolbar-menu :filter-status="true" :filter-action="true"></toolbar-menu>
          <v-card-text class="pa-0">
            ...
            >
              ...
              <template v-slot:item.address="{ item }">
                <small>
                  {{ item.house_number }} {{ item.barangay }}
                  {{ item.municipality }}
                  {{ item.province }}
                  {{ item.zip_code }}
                </small>
        ...
        data: [
          {
            ...
            house_number: "Blk 1",
            mobile: "091712345677",
            email: "jdlcruz@test.com",
            inquiry_date: "Nov 05, 2021",
            model: "Jazz",
            variant: "1.5 V MT",
            color: "Taffeta White",
