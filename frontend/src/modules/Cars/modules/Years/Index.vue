        ...
        >
          ...
          <template v-slot:item.actions="{ item }">
            <div class="text-no-wrap">
              ...
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <v-btn text icon @click="handleDeleteYearModel(item.id)">
...
export default {
  data() {
    return {
      ...
      cars: {
        ...
        data: this.$store.getters.GET_YEAR,
      },
    };
  },
  computed: {
  ...
  methods: {
    ...mapActions({
      getYearModels: "years/list",
      deleteYear: "years/delete",
    }),
    ...
    async handleDeleteYearModel(id) {
      this.loading = true;
