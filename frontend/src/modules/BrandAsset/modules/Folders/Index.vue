    ...
    <page-header>
      <template v-slot:action>
        <v-btn
          ...
          color="primary"
          exact
          :to="{ name: 'brand-asset.folders.create' }"
        >
            ...
            <div class="text-no-wrap">
              ...
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <v-btn
                    text
                    :to="{ name: 'brand-asset.folders.edit', params: { id: item.id } }"
                    icon
                    v-on="on"
                  >
              ...
              <v-tooltip bottom>
                <template v-slot:activator="{ on }">
                  <v-btn text icon v-on="on" @click="deleteFolder(item.id)">
