            ...
            >
              ...
              <template v-slot:item.editAction="{ item }">
                <div class="text-no-wrap">
                  ...
                  <!-- Preview -->
                  <!-- Edit -->
                  <v-tooltip v-if="userType == 'dealer'" bottom>
                    <template v-slot:activator="{ on }">
    ...
    return {
      ...
      resources: {
        ...
        headers: [
          ...
          { text: "SC Assigned Date", value: "sc_assigned_date", class: "text-no-wrap" },
          { text: "Status", value: "status", class: "text-no-wrap" },
          { text: "Action", value: "action", class: "text-no-wrap" },
          { text: "Date Updated", value: "date_updated", class: "text-no-wrap" },
          {
            text: "HCPI",
            value: "hcpi",
            text: "Actions",
